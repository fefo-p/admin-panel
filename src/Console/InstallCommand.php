...
class InstallCommand extends Command
{
    ...
    protected $signature = 'adminpanel:install {--verification : Indicates if user email verification support should be installed}
                                               ...
                                               {--with-user : Indicates if an admin user must be created}';
    ...
    public function handle()
    {
        ...
        $this->create_roles_and_permissions(with_user: $this->with_user);
...
EOF;
    ...
    protected function create_roles_and_permissions($with_user = false)
    {   
        if ($with_user) {
            User::create([
                'name' => 'Fernando M. Pintabona',
        ...
        $permissions = [
            [ 'name' => 'administrar usuarios', 'guard_name' => 'web'],
            [ 'name' => 'administrar roles', 'guard_name' => 'web'],
            [ 'name' => 'administrar permisos', 'guard_name' => 'web'],
        ];
