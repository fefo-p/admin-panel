        ...
        <div x-show="open" x-transition:enter="transition ease-in-out duration-300 transform" x-transition:enter-start="-translate-x-full"
            ...
            <div class="mt-5 flex-1 h-0 overflow-y-auto">
                <nav class="mt-5 px-2 space-y-1">
                    <a href="{{ route('adminpanel.dashboard') }}#" class="text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-base font-medium rounded-md @if(request()->routeIs('adminpanel.dashboard')) bg-gray-900 text-white @else text-gray-300 hover:bg-gray-700 hover:text-white @endif">
                    ...
                    <a href="{{ route('adminpanel.key') }}#" class="text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-base font-medium rounded-md @if(request()->routeIs('adminpanel.key')) bg-gray-900 text-white @else text-gray-300 hover:bg-gray-700 hover:text-white @endif">
                        <svg class="text-gray-300 mr-4 flex-shrink-0 h-6 w-6 @if(request()->routeIs('adminpanel.key')) text-gray-300 @else text-gray-400 group-hover:text-gray-300 @endif"
                    ...
                    <a href="{{ route('adminpanel.users') }}#" class="text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-base font-medium rounded-md @if(request()->routeIs('adminpanel.users')) bg-gray-900 text-white @else text-gray-300 hover:bg-gray-700 hover:text-white @endif">
                    ...
                    <a href="{{ route('adminpanel.roles') }}#" class="text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-base font-medium rounded-md @if(request()->routeIs('adminpanel.roles')) bg-gray-900 text-white @else text-gray-300 hover:bg-gray-700 hover:text-white @endif">
                    ...
                    <a href="{{ route('adminpanel.permissions') }}#" class="text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-base font-medium rounded-md @if(request()->routeIs('adminpanel.permissions')) bg-gray-900 text-white @else text-gray-300 hover:bg-gray-700 hover:text-white @endif">
    ...
    <div class="flex-1 flex flex-col min-h-0 bg-gray-800">
        ...
        <div class="flex-1 flex flex-col overflow-y-auto">
            <nav class="mt-5 flex-1 px-2 space-y-1">
                ...
                <a href="{{ route('adminpanel.key') }}"
                   class="text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md @if(request()->routeIs('adminpanel.key')) bg-gray-900 text-white @else text-gray-300 hover:bg-gray-700 hover:text-white @endif">
                    <svg class="text-gray-400 group-hover:text-gray-300 mr-3 flex-shrink-0 h-6 w-6 @if(request()->routeIs('adminpanel.key')) text-gray-300 @else text-gray-400 group-hover:text-gray-300 @endif"
                         x-description="Heroicon name: outline/users" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                         stroke="currentColor" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round"
                              d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path>
