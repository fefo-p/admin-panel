...
@php
    ...
    $header_alignment = $column->getTitle() == 'Acciones' ? 'text-right' : 'text-left';
@endphp

@if ($theme === 'tailwind')
    <th scope="col" {{
        $attributes->merge($customAttributes)
            ->class(['px-6 py-3 '.$header_alignment.' text-xs font-medium whitespace-nowrap text-gray-500 uppercase tracking-wider dark:bg-gray-800 dark:text-gray-400' => $customAttributes['default'] ?? true])
